...
const EditEquipmentPage = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const equipmentData = {
        id: parseInt(id),
        name: id === '1' ? 'Combine Harvester' : 
              id === '2' ? 'Tractor' : 
              id === '3' ? 'Seed Drill' : 
              id === '4' ? 'Rotavator' : 
              id === '5' ? 'Disc Harrow' : 'Equipment',
        category: id === '1' ? 'harvesting' : 
                  id === '2' ? 'tractor' : 
                  id === '3' ? 'planting' : 
                  id === '4' ? 'tillage' : 
                  id === '5' ? 'tillage' : '',
        description: 'Detailed description of the equipment including its features and benefits.',
        specifications: 'Technical specifications including model, year, dimensions, etc.',
        dailyRate: id === '1' ? '250' : 
                   id === '2' ? '150' : 
                   id === '3' ? '100' : 
                   id === '4' ? '80' : 
                   id === '5' ? '120' : '100',
        weeklyRate: id === '1' ? '1500' : 
                    id === '2' ? '900' : 
                    id === '3' ? '600' : 
                    id === '4' ? '480' : 
                    id === '5' ? '720' : '600',
        monthlyRate: id === '1' ? '5000' : 
                     id === '2' ? '3000' : 
                     id === '3' ? '2000' : 
                     id === '4' ? '1600' : 
                     id === '5' ? '2400' : '2000',
        availability: 'available',
        location: 'Farm County, State',
      ...
      // Set image previews
      setImagePreviewUrls(equipmentData.imageUrls);
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate API call to update equipment
    setTimeout(() => {
      setLoading(false);
    ...
    <div className="container-custom py-8">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Update details for your equipment listing</p>
        </div>
